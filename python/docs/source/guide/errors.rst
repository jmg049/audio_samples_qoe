...
Raised when a signal argument is neither an :class:`audio_samples.AudioSamples`
nor a path.
...
Raised when the metric pipeline itself fails. The most common cause is a signal
too short to extract a single analysis patch.
