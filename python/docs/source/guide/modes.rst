...
:func:`audio_samples_qoe.visqol` supports two modes, selected with the ``mode``
...
Use audio mode for music, broadcast content, or any full-bandwidth signal. The
SVR model is calibrated on codec and bandwidth-limiting degradations at 48 kHz.
...
Property           Value
=================  =================================================
Operating rate     Reference's native rate (degraded resampled)
...
Use speech mode for narrowband or wideband telephony, VoIP, or voice codec
evaluation. Upstream recommends **16 kHz** input. The exponential fit maps a
perfect NSIM of 1.0 to exactly 5.0, so identical signals always score 5.0.
...
deviation across the test corpus:

=====================  ==========  ==================================
Mode                   Max Δ MOS   Notes
=====================  ==========  ==================================
Audio                  0.025       FMA instruction scheduling
Speech (short clips)   0.08        Short-duration fit sensitivity
=====================  ==========  ==================================
